  ...
  <div class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-violet-700 via-violet-800 to-indigo-900 flex-col justify-between p-12">
    ...
    <div>
      <h1 class="text-4xl font-bold text-white leading-tight mb-4">
        Org Admin<br/>Dashboard
      </h1>
      <p class="text-violet-200 text-base leading-relaxed mb-10">
        Create, toggle, and manage feature flags for your organization — all in one place.
      </p>
      <div class="space-y-4">
        {#each ['Create & toggle feature flags', 'Isolated to your organization', 'Real-time flag state updates'] as item}
          <div class="flex items-center gap-3">
  ...
  <div class="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gray-50">
    <div class="w-full max-w-sm">
      ...
      <div class="mb-8">
        ...
        <p class="text-gray-500 text-sm mt-1">Access your feature flag dashboard</p>
      </div>
